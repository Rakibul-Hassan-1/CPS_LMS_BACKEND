...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    ownedCourses: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::course.course'
    >;
...
export interface ApiLessonLesson extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    contentType: Attribute.Enumeration<['text', 'video']> &
...
export interface ApiLessonProgressLessonProgress extends Schema.CollectionType {
...
export interface ApiQuestionQuestion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    correctIndex: Attribute.Integer & Attribute.Required;
